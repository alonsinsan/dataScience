...
class humano: # siempre después de 2 puntos va un indent en la siguiente línea, vsc los pone automáticamente
    ...
    def letrasNombre(self):
        nombre = self.nombre + " " + self.apellido_paterno + " " + self.apellido_materno # generamos la cadena de caracteres uniendo los atributos correspondientes al nombre
